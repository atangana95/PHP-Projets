...
<?php
    if(isset($_POST['send'])){
        if (empty($_POST['email']) || empty($_POST['password']) ) {
            ...
            $sql = "SELECT * FROM $tabellaPazienti WHERE  email = ? AND password = ?";
            $DatiUtente =$database->prepare($sql);
            $DatiUtente->execute(array($email,$password));
            if($DatiUtente->rowCount()>0){
                ...
                echo 'sei effettivamente registrato';
                    ...
                    header('Location: index_paziente.php');
            }
            else{
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body class="center">
        ...
        <form  method="post" class="container">
            ...
            <br><br>
            <a href="Registrazioni/Registrazione.php" class="btn btn-warning" ><p>non hai un account? Registrati</p></a>
        </form>
<?php
    include("../Footer.php");
?>